/* Generated by :claw at 2021-01-17T11:49:12.076374Z */
...
namespace std {
__CLAW_API unsigned long long __claw_alignof_std_unique_ptr_const_unsigned_char___std_default_delete_const_unsigned_char____() {
return alignof(std::unique_ptr<const unsigned char[],std::default_delete<const unsigned char[]>>);
}
}
...
namespace claw {
namespace filament {
__CLAW_API void __claw__ZN4claw8filament14InMemoryConfigC1EPKcS3_m(claw::filament::InMemoryConfig* __claw_this_, const unsigned char* name, const unsigned char* data, size_t size) {
...
namespace claw {
namespace filament {
__CLAW_API void __claw__ZN4claw8filament13InMemoryInputC1EPKcS3_m(claw::filament::InMemoryInput* __claw_this_, const unsigned char* name, const unsigned char* data, size_t size) {
...
namespace std {
__CLAW_API unsigned long long __claw_sizeof_std_basic_ostream_unsigned_char_() {
return sizeof(std::basic_ostream<unsigned char>);
}
}

namespace claw {
namespace filament {
__CLAW_API std::unique_ptr<const unsigned char[],std::default_delete<const unsigned char[]>>* __claw__ZN4claw8filament13InMemoryInput4readEv(std::unique_ptr<const unsigned char[],std::default_delete<const unsigned char[]>>* __claw_result_, claw::filament::InMemoryInput* __claw_this_) {
// /home/borodust/devel/repo/claw-filament/src/lib/ClawMemIo.h:83:35
new (__claw_result_) std::unique_ptr<const unsigned char[],std::default_delete<const unsigned char[]>>(__claw_this_->read());
...
namespace std {
__CLAW_API unsigned long long __claw_alignof_std_basic_ostream_unsigned_char_() {
return alignof(std::basic_ostream<unsigned char>);
}
}
...
namespace claw {
namespace filament {
__CLAW_API const unsigned char* __claw__ZNK4claw8filament13InMemoryInput7getNameEv(claw::filament::InMemoryInput* __claw_this_) {
...
namespace claw {
namespace filament {
__CLAW_API std::string* __claw__ZNK4claw8filament14InMemoryConfig8toStringB5cxx11Ev(std::string* __claw_result_, claw::filament::InMemoryConfig* __claw_this_) {
...
namespace std {
__CLAW_API unsigned long long __claw_sizeof_std_basic_string_unsigned_char_() {
return sizeof(std::basic_string<unsigned char>);
}
}
...
namespace std {
__CLAW_API unsigned long long __claw_alignof_std_basic_string_unsigned_char_() {
return alignof(std::basic_string<unsigned char>);
}
}
...
namespace std {
__CLAW_API unsigned long long __claw_sizeof_std_unique_ptr_const_unsigned_char___std_default_delete_const_unsigned_char____() {
return sizeof(std::unique_ptr<const unsigned char[],std::default_delete<const unsigned char[]>>);
}
}
